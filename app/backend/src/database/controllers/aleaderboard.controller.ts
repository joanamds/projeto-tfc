...
import ALeaderboardService from '../services/aleaderboard.service';
import TeamsModel from '../models/TeamsModel';
import MatchesModel from '../models/MatchesModel';

export default class LeaderboardController {
  private leaderboardService: ALeaderboardService;

  constructor() {
    this.leaderboardService = new ALeaderboardService(sequelize, TeamsModel, MatchesModel);
  }
